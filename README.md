...
In this fork, I have tried to enhance the pipeline feature like easy evaluation and prediction on model and option to freeze or unfreeze a particular number of the layer while doing transfer learning, as this eventually burgeon model accuracy in many cases.
